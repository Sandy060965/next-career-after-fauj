...
const Map<String, List<AptitudeDimension>> kVerticalDimensions = {
  'Operations & Process Excellence': [AptitudeDimension.operationsExecution, AptitudeDimension.structureProcess],
  'Supply Chain & Procurement': [AptitudeDimension.operationsExecution, AptitudeDimension.technicalAnalytical],
  'Security, Risk & Crisis Management': [AptitudeDimension.operationsExecution, AptitudeDimension.structureProcess],
  'Integrated Facilities Management': [AptitudeDimension.stakeholderRelationship, AptitudeDimension.structureProcess],
  'Aviation, Maritime & Fleet Management': [AptitudeDimension.operationsExecution, AptitudeDimension.structureProcess],
  'BFSI & Financial Crime Risk': [AptitudeDimension.technicalAnalytical, AptitudeDimension.structureProcess],
  'Project & Program Management (PMO)': [AptitudeDimension.operationsExecution, AptitudeDimension.structureProcess],
  'Strategy, Consulting & Chief of Staff': [AptitudeDimension.strategyGovernance, AptitudeDimension.stakeholderRelationship],
  'Business Development & Strategic Sales': [AptitudeDimension.stakeholderRelationship, AptitudeDimension.strategyGovernance],
  'HR, Talent Management & L&D': [AptitudeDimension.peopleLeadership, AptitudeDimension.stakeholderRelationship],
  'Corporate Affairs, ESG & Public Policy': [AptitudeDimension.strategyGovernance, AptitudeDimension.stakeholderRelationship],
  'Defence PSUs, Offsets & GovTech': [AptitudeDimension.strategyGovernance, AptitudeDimension.stakeholderRelationship],
  'IT Infrastructure & Cybersecurity': [AptitudeDimension.technicalAnalytical, AptitudeDimension.structureProcess],
  'Tech Product & Data Operations': [AptitudeDimension.technicalAnalytical, AptitudeDimension.strategyGovernance],
  'Manufacturing & Technical Systems': [AptitudeDimension.technicalAnalytical, AptitudeDimension.operationsExecution],
  'Aerospace, Drone & Defence Tech': [AptitudeDimension.technicalAnalytical, AptitudeDimension.operationsExecution],
};
