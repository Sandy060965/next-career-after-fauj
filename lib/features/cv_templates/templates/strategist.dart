...
pw.Document buildStrategist(
        ...
        child: pw.Container(
          ...
          child: pw.Column(
            children: [
              ...
              pw.Text(label,
                  style: styles.meta, textAlign: pw.TextAlign.center),
            ],
          ),
        ),
      );
  ...
  final tiles = <pw.Widget>[
    ...
    tile('${data.certifications.length + data.courses.length}',
        'Certifications'),
  ...
  doc.addPage(
    pw.MultiPage(
      ...
      build: (context) => [
        ...
        // Only the short, bounded Executive Summary/Strategic Capabilities
        // box shares a Row with anything — Professional Experience and
        // Education are separate top-level Column children below, since
        // their combined height scales with the officer's appointment
